...
class EnSpider(CrawlSpider):
    name = "en"
    allowed_domains = ["ezworktaiwan.wda.gov.tw", "law.moj.gov.tw"]
    start_urls = ["https://ezworktaiwan.wda.gov.tw/en"]
    
    rules = (
        Rule(LinkExtractor(allow=["ezworktaiwan.wda.gov.tw/en"], deny_extensions=['pdf']), callback="parse", follow=True),
